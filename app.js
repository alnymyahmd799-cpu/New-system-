...
function printInvoice() {
  ...
  win.document.write('<html dir="rtl"><head><title>فاتورة</title><style>' +
    '@page{size:A4;margin:12mm;}*{box-sizing:border-box;}body{font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",Arial,sans-serif;font-size:14px;line-height:1.55;padding:0;margin:0;background:#eef0f3;color:#1a1f36;-webkit-print-color-adjust:exact;print-color-adjust:exact;}' +
    ...
    '.invoice-accent{height:7px;background:linear-gradient(90deg,#1a1f36,#d97745);}' +
    '.invoice-body{padding:28px;}' +
    '.invoice-topbar{display:flex;justify-content:space-between;align-items:center;margin-bottom:18px;}' +
    '.invoice-title{font-size:21px;font-weight:800;color:#1a1f36;}' +
    '.invoice-badge{background:#1a1f36;color:#fff;font-size:14px;padding:5px 11px;border-radius:20px;font-weight:600;}' +
    ...
    '.invoice-label{font-size:12px;color:#99a1af;text-transform:uppercase;letter-spacing:0.5px;margin-bottom:3px;display:block;}' +
    '.invoice-value{font-size:14px;font-weight:700;color:#1a1f36;}' +
    '.invoice-sub{font-size:13px;color:#666;margin-top:2px;}' +
    'table{width:100%;border-collapse:collapse;margin-bottom:14px;}' +
    'th{color:#667785;padding:8px;font-size:12px;text-transform:uppercase;border-bottom:2px solid #1a1f36;}' +
    'td{padding:10px 7px;border-bottom:1px solid #eee;font-size:14px;text-align:center;}' +
    '.invoice-gift-line{font-size:13px;color:#a46b24;text-align:left;margin-bottom:8px;}' +
    '.invoice-grand-box{background:#1a1f36;color:#fff;border-radius:10px;padding:13px 16px;display:flex;justify-content:space-between;align-items:center;font-size:17px;font-weight:700;margin-bottom:6px;}' +
    '.invoice-footer{text-align:center;margin-top:18px;font-size:12px;color:#99a1af;}' +
